...
export const QUIZZES: Quiz[] = [
  {
    ...
    answerColumn: "answer",
    entries: [
      { answers: ["lakers", "los angeles lakers"], hints: { year: "1980", finals: "vs. 76ers (4-2)" } },
      { answers: ["celtics", "boston celtics"], hints: { year: "1981", finals: "vs. Rockets (4-2)" } },
      { answers: ["lakers", "los angeles lakers"], hints: { year: "1982", finals: "vs. 76ers (4-2)" } },
      ...
      { answers: ["lakers", "los angeles lakers"], hints: { year: "1985", finals: "vs. Celtics (4-2)" } },
      { answers: ["celtics", "boston celtics"], hints: { year: "1986", finals: "vs. Rockets (4-2)" } },
      { answers: ["lakers", "los angeles lakers"], hints: { year: "1987", finals: "vs. Celtics (4-2)" } },
      { answers: ["lakers", "los angeles lakers"], hints: { year: "1988", finals: "vs. Pistons (4-3)" } },
      ...
      { answers: ["lakers", "los angeles lakers"], hints: { year: "2000", finals: "vs. Pacers (4-2)" } },
      { answers: ["lakers", "los angeles lakers"], hints: { year: "2001", finals: "vs. 76ers (4-1)" } },
      { answers: ["lakers", "los angeles lakers"], hints: { year: "2002", finals: "vs. Nets (4-0)" } },
      ...
      { answers: ["lakers", "los angeles lakers"], hints: { year: "2009", finals: "vs. Magic (4-1)" } },
      { answers: ["lakers", "los angeles lakers"], hints: { year: "2010", finals: "vs. Celtics (4-3)" } },
      ...
      { answers: ["lakers", "los angeles lakers"], hints: { year: "2020", finals: "vs. Heat (4-2)" } },
